<?php
	// Need to start a session before destroying
	session_start();
	
	// Destroy session variables to "log out" the user. Basically forget the user's username and whether they logged in or not
	session_destroy();
?>
